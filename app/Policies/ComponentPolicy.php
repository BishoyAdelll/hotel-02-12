...
class ComponentPolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Component');
    }
    ...
    {
        return $user->checkPermissionTo('view Component');
    }
    ...
    {
        return $user->checkPermissionTo('create Component');
    }
    ...
    {
        return $user->checkPermissionTo('update Component');
    }
    ...
    {
        return $user->checkPermissionTo('delete Component');
    }
    ...
    {
        return $user->checkPermissionTo('restore Component');
    }
    ...
    {
        return $user->checkPermissionTo('force-delete Component');
    }
