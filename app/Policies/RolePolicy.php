...
class RolePolicy
{
     ...
     */
    public function restore(User $user, \Spatie\Permission\Models\Role $role): bool
    {
     ...
     */
    public function forceDelete(User $user, \Spatie\Permission\Models\Role $role): bool
    {
